...
namespace Core
{
    struct RenderContext
    {
        ...
        std::vector<glm::vec3> vertices;    // Zmienna przechowuj¹ca wierzcho³ki
        std::vector<unsigned int> indices;  // Zmienna przechowuj¹ca indeksy

        void initFromAssimpMesh(aiMesh* mesh);

        // Funkcja zwracaj¹ca VBO (Vertex Buffer Object)
        GLuint getVertexBuffer() const {
            return vertexBuffer;
        }

        // Funkcja zwracaj¹ca indeksy
